...
if("TRUE" STREQUAL "TRUE")
  set(slave_SOURCE_PREFIX /home/kisron/catkin_workspace/src/slave)
  set(slave_DEVEL_PREFIX /home/kisron/catkin_workspace/devel)
  set(slave_INSTALL_PREFIX "")
  set(slave_PREFIX ${slave_DEVEL_PREFIX})
else()
  set(slave_SOURCE_PREFIX "")
  set(slave_DEVEL_PREFIX "")
  set(slave_INSTALL_PREFIX /home/kisron/catkin_workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'slave' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kisron/catkin_workspace/src/slave/${idir}'.  ${_report}")
    endif()
