...
echo_and_run cd "/home/kisron/catkin_workspace/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kisron/catkin_workspace/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/kisron/catkin_workspace/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
