...
echo_and_run cd "/home/kisron/catkin_workspace/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kisron/catkin_workspace/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/kisron/catkin_workspace/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
