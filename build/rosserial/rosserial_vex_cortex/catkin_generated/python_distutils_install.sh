...
echo_and_run cd "/home/kisron/catkin_workspace/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kisron/catkin_workspace/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/kisron/catkin_workspace/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
