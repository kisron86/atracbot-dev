...
echo_and_run cd "/home/kisron/catkin_workspace/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/kisron/catkin_workspace/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/kisron/catkin_workspace/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
